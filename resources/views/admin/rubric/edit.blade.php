...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактирование рубрики: {{ $category['title'] }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <a href="{{ route('rubric.index') }}">Все рубрики</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('rubric.update', $category['id']) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $category['title'] }}" name="title" class="form-control"
                                        id="exampleInputEmail1" placeholder="Введите Title рубрики" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" value="@if($category['h1']){{$category['h1']}}@else{{session('old.h1')}}@endif" name="h1" class="form-control"
                                           id="exampleInputEmail1" placeholder="Введите Заголовок рубрики" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $category['alias'] }}" name="alias" class="form-control"
                                           id="exampleInputEmail1" placeholder="Введите алиас рубрики" required>
                                </div>
