...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактировать cтраницу: {{ $post['title'] }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <a href="{{ route('page.index') }}">Все страницы</a>
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('page.update', $post['id']) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <textarea name="scrip" cols="60">{{ $post['scrip'] }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if(count($post->images))
                                        ...
                                        @foreach($post->images as $img)
                                            <img src="{{asset('public/storage/page_image/'.$img->img)}}" alt="" class="img-uploaded" style="display: block; width: 300px">
                                        @endforeach
                                        </div>
                                    @endif
