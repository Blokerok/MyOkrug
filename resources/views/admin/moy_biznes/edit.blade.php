...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <a href="{{ route('moy-biznes.index') }}">Все статьи</a>
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('moy-biznes.update', $post['id']) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="@if(file_exists(storage_path('app/public/moy_biznes_image/'.$post['img'])))
                                    {{asset('public/storage/moy_biznes_image/'.$post['img'])}}
                                ...
                                <div class="form-group">
                                    ...
                                    @if(count($post->images))
                                        ...
                                        @foreach($post->images as $img)
                                            <img src="{{asset('public/storage/moy_biznes_image/'.$img->img)}}" alt="" class="img-uploaded" style="display: block; width: 300px">
                                        @endforeach
                                        </div>
                                    @endif
