...
class SendToGlava extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mail->subject("Новое обращение с портала ".getenv('APP_NAME')." !")
            ->greeting(" ")
            ->salutation(" ")
