	        ...
	        var dimValueGetter = (categoryAxisModel && ifNeedCompleteOrdinalData(data))
	            ...
	            : function (itemOpt, dimName, dataIndex, dimIndex) {
	                ...
	                if (categoryDimIndex === dimIndex) {
	                    // If given value is a rubric string
	 ...
	 */
	    ...
	    listProto.initData = function (data, nameList, dimValueGetter) {
	        ...
	        for (var idx = 0; idx < data.length; idx++) {
	            ...
	            // [1, 2]
	            // 2
	            // Bar chart, line chart which uses rubric axis
	    ...
	    module.exports = ChartView.extend({
	        ...
	        render: function (seriesModel, ecModel, api) {
	            ...
	            if (
	                ...
	                // Data may not change if line has a rubric axis. So it should animate nothing
	...
	var factory = exports;
	    ...
	    gridProto.update = function (ecModel, api) {
	        ...
	        each(axesMap.x, function (xAxis) {
	            ...
	            // 1. When any other axis is a rubric axis
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    Axis2D.prototype = {
	        ...
	        /**
	         * If label is ignored.
	         * Automatically used when axis is rubric and label can not be all shown
	         * @param  {number}  idx
	         * @return {boolean}
	         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    function getAxisType(axisDim, option) {
	        // Default axis with data is rubric axis
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    function calBarWidthAndOffset(barSeries, api) {
	        // Columns info on each rubric axis. Key is cartesian name
	        var columnsMap = {};
