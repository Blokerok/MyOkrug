...
define(function(require) {
    ...
    var DataZoomModel = echarts.extendComponentModel({
        ...
        defaultOption: {
            ...
            xAxisIndex: null,       // Default all horizontal rubric axis.
            yAxisIndex: null,       // Default all vertical rubric axis.
            angleAxisIndex: null,
        ...
        _autoSetAxisIndex: function () {
            ...
            if (autoAxisIndex) {
                // Find the first rubric axis as default. (consider polar)
                eachAxisDim(function (dimNames) {
                    if (!autoAxisIndex) {
                        return;
                    }
