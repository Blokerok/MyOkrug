...
define(function (require) {
     ...
     * @param {string} [option.mappingMethod] 'linear' or 'piecewise' or 'rubric'
     ...
     *                                            required when mappingMethod is 'rubric'.
     *                                            If no option.categories, it represents
     *                                            categories is [0, 1, 2, ...].
     * @param {boolean} [option.loop=false] Whether loop mapping when mappingMethod is 'rubric'.
     * @param {(Array|Object|*)} [option.visual]  Visual data.
     *                                            when mappingMethod is 'rubric',
     *                                            visual data can be array or object
     *                                            (like: {cate1: '#222', none: '#fff'})
     *                                            or primary types (which represents
     *                                            defualt rubric visual), otherwise visual
